const Intro = () => {
    return (
      <section className="py-32 w-full relative">
          <div className="max-w-[1100px] mx-auto px-8">
              <div className="grid grid-cols-1 md:grid-cols-[140px_1fr] gap-8 md:gap-16 items-start">
                  <div className="mb-4 md:mb-0">
                      <img src="/Assets/arrow-hero-section.png" alt="Hero Arrow Logo" className="w-[130px] h-auto drop-shadow-[0_0_15px_rgba(167,230,187,0.3)]" />
                  </div>
                  <div>
                      <p className="text-text-secondary text-lg md:text-xl font-normal leading-relaxed mb-12 text-justify">
                      ...
                      <div className="flex flex-col gap-6">
                           <div className="flex items-center gap-3 text-text-secondary text-base md:text-lg font-main font-medium tracking-wide">
                          ...
                          <div className="flex items-center gap-4 flex-wrap">
                              <span className="font-heading text-2xl md:text-3xl font-medium text-white">Currently, I'm a UI Designer Intern at</span>
                              <img src="/Assets/logo-lion-parcel.png" alt="Lion Parcel Logo" className="h-8 md:h-10 w-auto" />
                          </div>
                      </div>
                  </div>
              </div>
          ...
          <div className="w-[105%] md:w-[110%] relative mt-20 md:mt-32 -ml-[2.5%] md:-ml-[5%] rotate-[-2deg] bg-accent-green z-0 h-10 md:h-14 flex items-center shadow-[0_0_20px_rgba(167,230,187,0.2)]">
