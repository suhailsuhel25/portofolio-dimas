            ...
            <div className="max-w-[1300px] mx-auto px-6 md:px-8 grid grid-cols-1 md:grid-cols-[0.8fr_1.2fr] gap-8 md:gap-12 lg:gap-16 items-stretch">
                    ...
                    <div className="relative w-full max-w-[280px] md:max-w-[400px] mt-0 flex-grow flex items-start mx-auto md:mx-0">
                        <div className="relative w-full">
                            ...
                            <div className="absolute bottom-2 left-2 md:bottom-4 md:left-4 bg-white/95 backdrop-blur-md py-2 px-3 md:py-3 md:px-4 rounded-lg md:rounded-xl flex items-center gap-2 md:gap-4 z-20 shadow-xl border border-white/20">
                                ...
                                <a href="https://dribbble.com/Dimas_1006" className="text-[#1a1a1a] transition-all hover:scale-110 opacity-60 hover:opacity-100">
                ...
                <div className="reveal-right flex flex-col gap-3 md:gap-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                        {/* Software Card */}
                        <div className="about-card rounded-[20px] md:rounded-[35px] p-4 md:p-5 backdrop-blur-md overflow-hidden group flex flex-col">
                            {/* Corner Accents */}
                            <div className="corner-accent top-3 right-3"></div>
                            <div className="corner-accent bottom-3 left-3"></div>
                            ...
                            <p className="text-white/50 text-sm md:text-[17px] leading-relaxed mb-2 relative z-10">Designed key features for embedding in-platform data widgets, charts,</p>
                            <div className="flex-grow flex items-center justify-center py-2 relative z-10">
                                <div className="grid grid-cols-3 gap-3 w-full">
                                    {[
                                        { img: '/Assets/logo-flutter.png', name: 'Flutter' },
                                        ...
                                        { img: '/Assets/logo-vscode.png', name: 'VS Code' }
                                    ].map((tool, i) => (
                                        <div key={i} className="software-icon bg-[#121c22] aspect-square rounded-xl md:rounded-2xl flex items-center justify-center group/icon p-2 md:p-3">
                        ...
                        {/* Personal Card */}
                        <div className="about-card rounded-[20px] md:rounded-[35px] p-4 md:p-5 backdrop-blur-md overflow-hidden flex flex-col">
                            {/* Corner Accents */}
                            <div className="corner-accent top-3 left-3"></div>
                            <div className="corner-accent bottom-3 right-3"></div>
                            ...
                            <p className="text-white/50 text-sm md:text-[17px] leading-relaxed mb-2 relative z-10">Designed key features for embedding</p>
                            <div className="flex flex-col gap-6 relative mt-2 pb-2 z-10">
                                ...
                                <span className="self-start bg-gradient-to-r from-[#a7e6bb] to-[#82c9a1] text-[#081B28] py-2 px-5 md:py-3 md:px-8 rounded-full text-[13px] md:text-[16px] font-extrabold shadow-xl border-2 border-white/10 transition-transform hover:scale-105 -rotate-[7deg] ml-4 -mt-1">Product Designer</span>
                                <div className="flex justify-end pr-8 -mt-1">
                                    <span className="bg-gradient-to-r from-[#a7e6bb] to-[#82c9a1] text-[#081B28] py-3 px-9 rounded-full text-[16px] font-extrabold shadow-xl border-2 border-white/10 transition-transform hover:scale-105 rotate-[4deg]">Mobile Dev</span>
                                </div>
                            </div>
                        </div>
                    </div>

                    {/* Education Card - Spanning bottom with shimmer border */}
                    <div className="about-card about-card-edu rounded-[20px] md:rounded-[30px] p-5 md:p-7 flex items-center gap-4 md:gap-6 backdrop-blur-md overflow-hidden group">
                        {/* Corner Accents */}
                        <div className="corner-accent top-3 right-4"></div>
                        <div className="corner-accent top-3 left-4"></div>
                        <div className="corner-accent bottom-3 right-4"></div>
                        <div className="corner-accent bottom-3 left-4"></div>
